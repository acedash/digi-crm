...
import { CRUISE_OPTIONS } from '../../../utils/bookingConstants';
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px', marginBottom: '16px' }}>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <input 
                  ...
                  value={cruise.line || ''}
                  onChange={(e) => setCruise({ ...cruise, line: e.target.value })}
                ...
                />
                <datalist id="cruise-options">
                  {CRUISE_OPTIONS.map(opt => <option key={opt} value={opt} />)}
                </datalist>
              </div>
